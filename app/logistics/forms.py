...
class OrderForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'cargo_spaces': forms.TextInput(attrs={'class': 'digits'}),
            'cargo_weight': forms.TextInput(attrs={'class': 'digits'}),
            'cargo_volume': forms.TextInput(attrs={'class': 'digits'}),
            'cargo_value': forms.TextInput(attrs={'class': 'digits', 'disabled': 'disabled'}),
